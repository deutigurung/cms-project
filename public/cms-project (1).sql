...
CREATE TABLE `events` (
  ...
  `available_tickets` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `organizer_website` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `organizer_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `venue_location` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `venue_phone` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `events` (`id`, `title`, `description`, `status`, `date`, `time`, `cost`, `available_tickets`, `image`, `organizer`, `organizer_email`, `organizer_website`, `organizer_phone`, `slug`, `venue_location`, `venue_phone`, `created_at`, `updated_at`) VALUES
(1, 'event first', '<p>this is the first events</p>', 1, '2022-08-10', '10:30 AM', NULL, NULL, 'event-pic-1.jpg', 'Nepal Bank', 'nepal@bank.com', NULL, '1234566', 'event-first', 'kathmandu,nepal', NULL, '2022-08-09 08:54:24', '2022-08-09 09:40:06'),
(2, 'Exploring the wild side in an industrial jungle bengle', '<p><span style=\"color: rgb(106, 106, 106); font-family: Hind, sans-serif; font-size: 14px;\">Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</span><span style=\"color: rgb(106, 106, 106); font-family: Hind, sans-serif; font-size: 14px;\">Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</span><span style=\"color: rgb(106, 106, 106); font-family: Hind, sans-serif; font-size: 14px;\">Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</span><span style=\"color: rgb(106, 106, 106); font-family: Hind, sans-serif; font-size: 14px;\">Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</span><span style=\"color: rgb(106, 106, 106); font-family: Hind, sans-serif; font-size: 14px;\">Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</span><span style=\"color: rgb(106, 106, 106); font-family: Hind, sans-serif; font-size: 14px;\">Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</span><span style=\"color: rgb(106, 106, 106); font-family: Hind, sans-serif; font-size: 14px;\">Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</span><br></p>', 1, '2022-08-01', '9:00 AM', NULL, NULL, 'event-pic-2.jpg', 'Self', 'admin@gmail.com', NULL, '1234566', 'exploring-the-wild-side-in-an-industrial-jungle-bengle', 'Gokarna Party place ,kathmandu,nepal', '01246333', '2022-08-09 09:52:28', '2022-08-09 09:52:29');
...
(11, 'Events', 'events', 0, '2022-08-10 00:29:11', '2022-08-10 00:29:11');
...
(25, '2022_03_02_085931_add_roles_to_users_table', 16),
(27, '2022_03_04_085317_create_tests_table', 17),
(28, '2022_03_11_121616_create_user_verifies_table', 18),
(29, '2022_08_07_152557_create_events_table', 19),
(32, '2022_08_10_064135_create_notifications_table', 20),
(33, '2022_08_10_081145_add_email_to_team_members_table', 21);
...
CREATE TABLE `notifications` (
  ...
  `notification_for` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `notification_by` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `notifications` (`id`, `type`, `notification_for`, `notification_by`, `email`, `phone`, `message`, `mark_read`, `created_at`, `updated_at`) VALUES
(1, 'Demo Request', 'Admin', 'ram', 'ram@gmail.com', '9741414141', 'We are requesting for service - Mechanical Works', 1, '2022-08-10 01:11:47', '2022-08-10 02:59:24'),
(2, 'Demo Request', 'Admin', 'Test', NULL, NULL, 'We are requesting for service - Material Engineering', 0, '2022-08-10 03:00:37', '2022-08-10 03:00:37');
...
('admin@gmail.com', '$2y$10$22EIsHjAAQM8bq4peDdq2eCxaD.ddXDsFezLjCSQDk9MfN/9Sb1LW', '2022-03-13 02:43:38'),
('manager@gmail.com', 'GstQPzBYNUHVIslKlooRSwetlVbPNqVKnqG2fUnzh6aX1QiCiGqFuA2B7RzbZqTl', '2022-03-13 03:08:54');
...
(2, 'de', 'de', 'de@de.df', '12121', 'We are requesting for service - Mechanical Works', '2022-03-03 05:40:59', '2022-03-03 05:40:59'),
(3, 'ram', 'sharma', 'ram@gmail.com', '9741414141', 'We are requesting for service - Mechanical Works', '2022-08-10 01:11:47', '2022-08-10 01:11:47'),
(4, 'Test', 'admin', 'admin@user.com', '984545445', 'We are requesting for service - Material Engineering', '2022-08-10 03:00:37', '2022-08-10 03:00:37');
...
INSERT INTO `team_members` (`id`, `title`, `email`, `phone`, `address`, `photo`, `designation`, `description`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Evan', 'evan@gmail.com', NULL, 'address', 'team-pic-1.jpg', 'CEO', 'tetete', 1, '2022-01-10 05:43:11', '2022-08-10 02:34:09'),
(2, 'Michal Jackson', 'michal@gmail.com', '9741414141', 'address,nepal', 'team-pic-2.jpg', 'Manager', NULL, 1, '2022-01-26 01:10:49', '2022-08-10 02:35:41'),
(3, 'Jenny Talyor', '', NULL, NULL, 'team-pic-3.jpg', 'Marketing Supervisor', NULL, 1, '2022-01-26 01:11:30', '2022-01-26 01:11:30'),
(4, 'Tom Jerry', '', NULL, NULL, 'team-pic-4.jpg', 'Director of the board', NULL, 1, '2022-01-26 01:12:40', '2022-01-26 01:12:40');
...
INSERT INTO `tests` (`id`, `token`, `data`, `created_at`, `updated_at`) VALUES
(1, '1646386125', '{\"name\":\"deuti\",\"email\":\"fdfd@dsd.dsds\",\"address\":\"dsds\",\"roles\":\"systemuser\",\"mobile_number\":\"21212\"}', NULL, '2022-03-04 04:27:17'),
(2, '1646386159', '{\"name\":\"fdfd\",\"email\":\"fdfd@dsd.dsds\",\"address\":\"dsds\",\"roles\":\"admin\",\"mobile_number\":\"21212\"}', NULL, NULL);
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `roles`, `image`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'admin@gmail.com', NULL, '$2y$10$sniHYjqr6hgafrN2/4WYc.B17ilWbDFoXc4LZevWWUMoolMJCrkJi', 'admin', NULL, NULL, '2022-01-10 03:18:02', '2022-03-02 03:57:16'),
(2, 'user', 'user@user.com', NULL, '$2y$10$lsl3aX5vtJbZ8uEmqbaDrOTvCaM1Z8FBGw4vUdz6NOZLCM2ramxR2', 'user', NULL, NULL, '2022-03-02 03:36:57', '2022-03-02 03:51:19'),
(3, 'Manager', 'manager@gmail.com', NULL, '$2y$10$9l5wa/f1fXml.7XdNXAyXugSdpvWlKT9vwidGGmMZHrv4rcxSUMPy', 'systemuser', NULL, NULL, '2022-03-02 03:51:57', '2022-03-02 03:51:57'),
(9, 'deuti grg', 'deuti@ininepal.com', '2022-03-13 08:01:27', '$2y$10$KR/2rW9YKv2FsdmumQrKReF.oix.axpJFHfuk3SP2iB9o8BliN/Ia', 'user', NULL, NULL, '2022-03-13 02:09:25', '2022-03-13 03:12:46'),
(10, 'Tom', 'gurungdeuti@gmail.com', '2022-03-13 02:33:12', '$2y$10$Q07KFmfZw7Okbz8NZClpQu4yjU2nQxaRt1Ualpjtxyrzx9E6kyWdG', 'user', NULL, NULL, '2022-03-13 02:29:58', '2022-03-13 03:03:47');
...
(9, 'O1frvIMXAqFiIOlC1T3zgMDzkyASejFiwzfdU0oTaNxEwmIqfa24PZ3P4k8k5L8d', '2022-03-13 02:09:25', '2022-03-13 02:09:25');
